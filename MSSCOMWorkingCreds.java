...
public class MSSCOMWorkingCreds {
...
//66,67,68,69
		  ...
		  credentialName.sendKeys("MSSCOMGood Credentials"+x);
		  
		  WebElement userName1 = driver.findElement(By.id("textfield-1362-inputEl"));
		  userName1.sendKeys("sa");
		  
		  WebElement password1 = driver.findElement(By.id("textfield-1363-inputEl"));
