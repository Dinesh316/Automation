...
try {
	...
	e.printStackTrace();
		  ...
		  credentialName.sendKeys("Good Credentials1");
		  ...
		  WebElement wait = (new WebDriverWait(driver, 10)).until(ExpectedConditions.elementToBeClickable(By.xpath("//span[normalize-space()='Save Settings']")));
