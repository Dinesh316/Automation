...
public class SQLServWorkingCredentials {
...
try {
	...
	e.printStackTrace();
		  ...
		  credentialName.sendKeys("SQLServGood Credentials00");
		  
		  WebElement userName1 = driver.findElement(By.name("textfield-1464-inputEl"));
		  userName1.sendKeys("sa");
		  
		  WebElement password1 = driver.findElement(By.name("textfield-1465-inputEl"));
