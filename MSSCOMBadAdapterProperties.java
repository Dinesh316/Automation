...
public class MSSCOMBadAdapterProperties {
...
try {
	...
	e.printStackTrace();
		  ...
		  WebElement msgType = driver.findElement(By.id("title-1350-textEl"));
...
//		 Bad Port Name
		  ...
		  WebElement msgType1 = driver.findElement(By.id("title-1350-textEl"));
		  if(msgType1.getText().equals("Error"))
		  {
...
//		Bad DB Name
		  ...
		  WebElement msgType2 = driver.findElement(By.id("title-1350-textEl"));
		  if(msgType2.getText().equals("Error"))
		  {
