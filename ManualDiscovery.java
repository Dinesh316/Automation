		            	...
		            	Cell cell1 = sheet1.getRow(i1).getCell(0);
		            	 ...
		            	 if(keyValue1.equals(searchkey1)){
							...
							//		  WebElement wait111 = (new WebDriverWait(driver, 10)).until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='OK']")));
									  ...
									  okButton2.click();
//		            					}
									  WebElement wait10 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Close']")));
									  WebElement closeButton = driver.findElement(By.xpath("//a[normalize-space()='Close']"));
									  closeButton.click();
				  ...
				  WebElement wait2222 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//div//div//label[contains(.,'Configuration')]")));
				  	WebElement managementLink =driver.findElement(By.xpath("//div//div//label[contains(.,'Configuration')]"));
				  	managementLink.click();
				  
				    WebElement wait222 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//div//section//span[contains(.,'Inventory Explorer')]")));
				  	WebElement licensingLink =driver.findElement(By.xpath("//div//section//span[contains(.,'Inventory Explorer')]"));
				  	licensingLink.click();
				  	...
				  	try {			  
						...
						WebElement wait2 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//a//span[contains(@style,'background-image:url(images/clarity-light/i_discoverResource.gif);')]")));
					  	WebElement discoverResourcesButton =driver.findElement(By.xpath("//a//span[contains(@style,'background-image:url(images/clarity-light/i_discoverResource.gif);')]"));
					  	discoverResourcesButton.click();
					  	
					  	WebElement wait62 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='button-1527']")));
						  WebElement closeButton2 = driver.findElement(By.xpath("//*[@id='button-1527']"));
						 closeButton2.click();
							...
							WebElement wait21 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//a//span[contains(@style,'background-image:url(images/clarity-light/i_discoverResource.gif);')]")));
						  	WebElement discoverResourcesButton1 =driver.findElement(By.xpath("//a//span[contains(@style,'background-image:url(images/clarity-light/i_discoverResource.gif);')]"));
						  	discoverResourcesButton1.click();
						  	...
						  	WebElement wait231 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[descendant::td[contains(.,'Collector')]]//input[@type='text']")));
						  	WebElement collectorField1 =driver.findElement(By.xpath("//tr[descendant::td[contains(.,'Collector')]]//input[@type='text']"));
						  	collectorField1.clear();
						  	collectorField1.sendKeys("vRealize Operations Manager Collector-vr66-dgondhesi.bluemedora.localnet-1");
						  	
					  	WebElement wait3 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[descendant::td[contains(.,'Adapter Type')]]//input[@type='text']")));
					  	WebElement adapterTypeField =driver.findElement(By.xpath("//tr[descendant::td[contains(.,'Adapter Type')]]//input[@type='text']"));
					  	adapterTypeField.clear();
					  	adapterTypeField.sendKeys(searchkey1);
					  	
					  	WebElement wait10 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[descendant::td[contains(.,'Adapter Instance')]]//input[@type='text']")));
					  	WebElement adapterInstanceField1 =driver.findElement(By.xpath("//tr[descendant::td[contains(.,'Adapter Instance')]]//input[@type='text']"));
					  	adapterInstanceField1.clear();
					  	
					  	WebElement wait9 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[descendant::td[contains(.,'Adapter Instance')]]//div[contains(@id,'picker')]")));
					  	WebElement adapterInstanceArrow =driver.findElement(By.xpath("//tr[descendant::td[contains(.,'Adapter Instance')]]//div[contains(@id,'picker')]"));
					  	adapterInstanceArrow.click();
					  	
					  	
					  	WebElement wait4 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//div//div//ul/div[normalize-space()='MSCOM Manual Instance']")));
					  	WebElement adapterInstanceField =driver.findElement(By.xpath("//div//div//ul/div[normalize-space()='MSCOM Manual Instance']"));
					  	adapterInstanceField.click();
					  	
					  	WebElement wait5 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[descendant::td[contains(.,'Discovery Info')]]//input[@type='text']")));
					  	WebElement discoveryInfoField =driver.findElement(By.xpath("//tr[descendant::td[contains(.,'Discovery Info')]]//input[@type='text']"));
					  	discoveryInfoField.clear();
					  	discoveryInfoField.sendKeys("Basic discovery");
					  
					  	 WebElement wait6 = (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='button-1528']")));
						  WebElement okButton2 = driver.findElement(By.xpath("//*[@id='button-1528']"));
						  okButton2.click();
						  
						  List<WebElement> checkboxes = driver.findElements(By.xpath("//td//div//img[contains(@class,'checkcolumn')]"));
						  for(int x=1; x<checkboxes.size();x++){
