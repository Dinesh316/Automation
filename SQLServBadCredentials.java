...
public class SQLServBadCredentials {
...
try {
	...
	e.printStackTrace();
		  ...
		  hostName.clear();
		  hostName.sendKeys("mssql-ag1-sql");
		  ...
		  credentialName.sendKeys("SQLServBad Credentials"+j+j);
		  
		  WebElement userName1 = driver.findElement(By.name("cred_::_003016022SqlServerAdaptersql_server_credentialsusername"));
		  userName1.clear();
		  userName1.sendKeys(username[j]);
		  
		  WebElement password11 = driver.findElement(By.name("cred_::_003016022SqlServerAdaptersql_server_credentialspassword"));
		  password11.clear();
