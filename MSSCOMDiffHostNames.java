...
public class MSSCOMDiffHostNames {
...
try {
	...
	e.printStackTrace();
		  ...
		  for(int j=0;j<3;j++){
				String[] inputHostName = {"scom-win12-dev2","10.77.3.69","scom-win12-dev2.bluemedora.localnet"};
		  ...
		  if(connectionSuccessMsg.getText().equals("Test connection successful.")){
			  System.out.println("PASSED:Test connection successful with hostname:"+inputHostName[j]);
		  }
		  else{
			  System.out.println("FAILED:Test Connection NOT Successful with hostname:"+inputHostName[j]);
		  }
